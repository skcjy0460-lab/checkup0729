...
app.py
======
국민건강보험공단 검진기관 찾기 - 홈 화면.

멀티페이지 구조:
  app.py                        : 홈 (소개, DB 현황, 국가검진 대상 자동판별)
  pages/1_🔍_검진기관_찾기.py     : 조건별 검색 + AI 추천
  pages/2_💬_AI_상담.py           : 자연어 상담 챗봇
"""

import streamlit as st

from utils.db_builder import build_database, CHECKUP_LABELS
...
# ---------------------------------------------------------------------------
# DB 자동 빌드 (Streamlit Cloud 기동 시 최초 1회, 이후 세션 캐시)
# ---------------------------------------------------------------------------
